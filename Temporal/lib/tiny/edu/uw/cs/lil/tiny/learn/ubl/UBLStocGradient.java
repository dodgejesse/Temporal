		...
		for (final SplittingPair split : allSplits) {
			...
			for (int splittingPoint = begin; splittingPoint < end; splittingPoint++) {
				...
				if (chartLeftCell == null
						|| chartLeftCell.getMaxInsideScore() >= newLeftCell
								.getMaxInsideScore()) {
				...
				if (chartRightCell == null
						|| chartRightCell.getMaxInsideScore() >= newRightCell
								.getMaxInsideScore()) {
				...
				final double improvement = newRootCell.getMaxInsideScore()
						- cell.getMaxInsideScore();
