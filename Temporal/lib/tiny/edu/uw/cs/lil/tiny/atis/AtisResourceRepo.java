...
import edu.uw.cs.lil.tiny.parser.ccg.features.basic.resources.LogicalExpressionCooccurrenceFeatureSetCreator;
import edu.uw.cs.lil.tiny.parser.ccg.features.basic.resources.LogicalExpressionCoordinationFeatureSetCreator;
import edu.uw.cs.lil.tiny.parser.ccg.features.basic.resources.LogicalExpressionTypeFeatureSetCreator;
...
public class AtisResourceRepo extends ResourceCreatorRepository {
	...
	public AtisResourceRepo() {
		...
		registerResourceCreator(new UniformScorerCreator());
