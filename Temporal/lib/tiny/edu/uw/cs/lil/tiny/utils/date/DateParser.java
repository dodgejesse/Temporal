...
public class DateParser {
	...
	public static void main(String[] args) {
		...
		System.out.println(parser
				.parse("monday, september thirtieth, two thousand two"));
		System.out.println(parser.parse("monday, september thirtieth"));
		System.out.println(parser.parse("sunday, july twenty"));
		System.out.println(parser.parse("sunday, july second"));
		System.out.println(parser.parse("sunday, july twenty second"));
		System.out.println(parser.parse("november sixth"));
		System.out.println(parser.parse("september twenty fourth"));
		System.out.println(parser.parse("friday september twenty first"));
		System.out.println(parser.parse("september twenty first"));
		System.out.println(parser.parse("october the eighth"));
		System.out.println(parser.parse("august fourteenth tuesday"));
	}
