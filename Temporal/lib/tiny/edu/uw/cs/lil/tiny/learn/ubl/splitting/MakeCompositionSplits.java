...
public class MakeCompositionSplits implements ILogicalExpressionVisitor {
	...
	// //
	// .parse("NP/(S|NP) : (lambda $1:<e,t> (argmax:e (lambda $2:e (and:t (state:t $2) ($1 $2))) (lambda $0:e (size:i $0))))");
	// .parse("S/(S|NP) : (lambda $0:<e,t> (lambda $1:e (and:t (river:t $1) ($0 $1))))");
	// System.out.println(cat);
	//
	// for (final SplittingPair pair : MakeCompositionSplits.of(cat,
	// categoryServices)) {
