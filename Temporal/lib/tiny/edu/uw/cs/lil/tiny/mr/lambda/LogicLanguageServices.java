...
public class LogicLanguageServices {
	 ...
	 * TODO [yoav] [literaltyping] This should default to strict and then
	 * experiments should set the flexible comparator.
	 */
	private final ITypeComparator								typeComparator						= new FlexibleTypeComparator();
	
	private final TypeRepository								typeRepository;
	
	public LogicLanguageServices(TypeRepository typeRepository) {
		this(typeRepository, null);
	}
	
	public LogicLanguageServices(TypeRepository typeRepository,
			String numeralTypeName) {
