...
import edu.uw.cs.lil.temporal.predicates.TemporalIntersect;
import edu.uw.cs.lil.temporal.predicates.TemporalMultiplication;
import edu.uw.cs.lil.temporal.predicates.TemporalNext;
import edu.uw.cs.lil.temporal.predicates.TemporalNth;
import edu.uw.cs.lil.temporal.predicates.TemporalPredicate;
import edu.uw.cs.lil.temporal.predicates.TemporalPrevious;
import edu.uw.cs.lil.temporal.predicates.TemporalReference;
import edu.uw.cs.lil.temporal.predicates.TemporalThis;
...
import edu.uw.cs.lil.temporal.util.TemporalUtil;
