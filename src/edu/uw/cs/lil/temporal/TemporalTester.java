...
import edu.uw.cs.lil.temporal.featuresets.TemporalContextFeatureSet;
import edu.uw.cs.lil.temporal.featuresets.TemporalDayOfWeekFeatureSet;
import edu.uw.cs.lil.temporal.featuresets.TemporalReferenceFeatureSet;
import edu.uw.cs.lil.temporal.structures.TemporalDataset;
import edu.uw.cs.lil.temporal.structures.TemporalMention;
import edu.uw.cs.lil.temporal.structures.TemporalMentionDataset;
import edu.uw.cs.lil.temporal.structures.TemporalResult;
...
public class TemporalTester extends Thread {
	...
	public TemporalTester(TemporalDataset trainData, TemporalDataset testData, TemporalStatistics stats){
